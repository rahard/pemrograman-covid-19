...
# ambil nama file
frekap = glob(dir + "/" + "csv_tabel_meninggal_*")[0]
print(frekap)
...
judul = "Jumlah Meninggal COVID-19 di Jawa Barat sd. " + tanggal
plt.title(judul)
plt.xlabel('Tanggal')
plt.ylabel("Jumlah")
...
# plt.show()
output = outputdir+"/meninggal.png"
try:
   plt.savefig(output)
except:
